...
![Small UI Improvements](./img/reports.webp)

### Config Font Size

![Font Size](./img/font-size.webp)

### Config Exists

![Config Exists](./img/exists_config.webp)

### Updated Record Config Header

![Config Header](./img/report-label.webp)

### Change Dashboard Headers Order

![Change Dashboard Headers Order](./img/config-header.webp)
