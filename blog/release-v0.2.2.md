...
![Import logs](/bublik-release/blog/img/import-log.webp)
...
- Live import: incorrect call to the do_nothing() function [#5](https://github.com/ts-factory/bublik/issues/5)
