...
![Link](/bublik-release/blog/img/import-1.webp)
...
![Grouped Events](/bublik-release/blog/img/import-2.webp)

Added button to trigger re-import in case of an import error

![Re-import](/bublik-release/blog/img/import-3.webp)

Added "Project" field to import form to specify the project for the imported run.

![Project Field](/bublik-release/blog/img/import-4.webp)

### Run Comments

Added support for comments on run details page

![Run Comment](/bublik-release/blog/img/run-1.webp)
...
- **signals:** fix meta categorization call on config change ([cd56661](https://github.com/ts-factory/bublik/commit/cd56661cbf47f39b4e9e78a28dc9235a812c5505))
- **config:** fix config content generation ([719e3ec](https://github.com/ts-factory/bublik/commit/719e3ecab79d71c7900a700af391772d31058fd2))
