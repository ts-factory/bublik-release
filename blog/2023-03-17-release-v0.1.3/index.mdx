...
![Log page tree skipped tests](./img/SCR-20230318-chrl.webp)

### Added more data to import event table

![Import page table](./img/SCR-20230318-cjpi.webp)

### New form for importing multiple runs at once

![Import multiple runs at once](./img/SCR-20230317-hkff.webp)

![Import list results](./img/SCR-20230317-hlar.webp)
