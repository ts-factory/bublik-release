...
![Button to open toolbar](/bublik-release/blog/img/toolbar-1.webp)

![Opened toolbar](/bublik-release/blog/img/toolbar-2.webp)

### Log time

You can now see time delta relative to selected row if you enable "time delta mode"

![Log delta](/bublik-release/blog/img/delta-1.webp)
...
![Sidebar](/bublik-release/blog/img/sidebar-1.webp)
...
![Import form](/bublik-release/blog/img/import-form-1.webp)
