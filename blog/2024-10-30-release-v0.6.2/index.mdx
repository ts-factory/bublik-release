...
![Runs selection](./img/runs-multiple.webp)

#### Page

![Runs merged page](./img/multiple-page.webp)

### Reports Button

![Log button](./img/log-reports-button.webp)
...
![New Bug Drawer](./img/new-bug-drawer.webp)

### Updated Report Headers

![New Headers](./img/headers.webp)
