...
![Report iterations](./img/iterations.png)
...
![Log Preview Modal](./img/log-preview-modal.png)
...
- **requirements:** update packages versions to pick up bug fixes ([dd6ff53](https://github.com/ts-factory/bublik/commit/dd6ff534bfa24fa7e0f95b5260b17514b28203ad))
- **flower:** fix no workers in flower after start ([e0dd52d](https://github.com/ts-factory/bublik/commit/e0dd52d297f1ddf7329edaaa7b7692880c78f0ae))
- **report:** fix empty percentage base value handling ([2dbcbbf](https://github.com/ts-factory/bublik/commit/2dbcbbf720f755183e8d19a672e48ca3aedec6d9))
- **report:** fix invalid iterations handling ([d94c351](https://github.com/ts-factory/bublik/commit/d94c3514156e839acd0c6d5e4e073aba6783cbd4))

#### 🚀 New Feature

- **requirements:** fix incompatibility with Ubuntu 24.04 ([76dd9fa](https://github.com/ts-factory/bublik/commit/76dd9fa31e1ec8e63dc1f6ac5d8b0e1858adef38))
- **readme:** update info about supported OS versions ([34e0d1d](https://github.com/ts-factory/bublik/commit/34e0d1dfd90693b29249047d688da15ec7459d7d))
- **run stats:** make the conclusion clearer ([04622c0](https://github.com/ts-factory/bublik/commit/04622c0ea19c9768370508687fb23997f0da84c2))
- **report:** expand possibilities of measurement setting ([2ebe8e1](https://github.com/ts-factory/bublik/commit/2ebe8e19470b52d64f3bac0257381a6e7504a265))
...
- **report:** update report content structure ([8cf967d](https://github.com/ts-factory/bublik/commit/8cf967d975785aa4acd719f65aa40fdc01d5e09f))
- **report:** ensure the uniqueness of IDs throughout the report ([ac097e7](https://github.com/ts-factory/bublik/commit/ac097e74a6e4242001ece3a856c27e558b0d7b43))


#### ♻ Code Refactoring

- **settings:** fix import of settings ([7743293](https://github.com/ts-factory/bublik/commit/7743293551c47ea12f34c8bb915ab15d15b0fd59))
- **auth:** remove dup of getting user by access token ([b1a59c4](https://github.com/ts-factory/bublik/commit/b1a59c4e04b29208facbe690c951b6ce3236f9e2))
- **auth:** decompose admin verification for readability ([3c30fd3](https://github.com/ts-factory/bublik/commit/3c30fd3e8512c987262d174c9e4aa7143cd93e28))
- **auth:** unify authentication and admin verification ([da5d908](https://github.com/ts-factory/bublik/commit/da5d908aa6d88c1bc3d2681e051d8fabec33a180))
- **auth:** move auth funcs for consistency ([eac0014](https://github.com/ts-factory/bublik/commit/eac00148745a52295569217c709d8c6818d5bf17))
