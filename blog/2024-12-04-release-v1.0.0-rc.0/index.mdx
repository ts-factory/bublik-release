...
3. Call the configuration reformatting command: `python manage.py reformat_configs`
:::warning
...
:::
4. Call the database cleanup command: `python manage.py cleanup_db`
...
3. `cd bublik-ui`
4. `git remote update`
5. `git checkout release-v1.0.0`

### Additional
:::danger
It is necessary to re-import runs that was imported when Bublik was using versions v0.6.0 to v0.7.1 to avoid potential errors in statistical calculations and charts in history.
:::
