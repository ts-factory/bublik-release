...
![Table](/bublik-release/blog/img/table.webp)

### Editing Note

![Edit](/bublik-release/blog/img/edit.webp)

:::tip
By default, comment management is available only to administrators. To remove this restriction, you need to add `NOT_PERMISSION_REQUIRED_ACTIONS = ['manage_test_comments']` to your project configuration (_per_conf.py_).
:::

### All Notes Popover

![all](/bublik-release/blog/img/all.webp)

### Editing Note Inside Popover

![edit-all](/bublik-release/blog/img/edit-all.webp)

### More Informative Report Records Headers

![Report](/bublik-release/blog/img/report_headers.webp)
...
- **report:** fix f-string quotes error ([0c20433](https://github.com/ts-factory/bublik/commit/0c20433a93ad4c902d94c3b054e1c043ea87955c))
