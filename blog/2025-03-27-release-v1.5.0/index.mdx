...
![New Run Page Filtering](./img/run-filters.png)
...
![Log Artifacts](./img/artifacts.png)
...
Read more about artifacts in our [documentation](/configuration/artifacts).
