...
![Runs selection](/bublik-release/blog/img/runs-multiple.webp)

#### Page

![Runs merged page](/bublik-release/blog/img/multiple-page.webp)

### Reports Button

![Log button](/bublik-release/blog/img/log-reports-button.webp)

### Log Preview

We've made small redesign adjustment and also added new bug button to preview

![Log Preview](/bublik-release/blog/img/log-preview.webp)

### New Bug

Small redesign to match new log preview style

![New Bug Drawer](/bublik-release/blog/img/new-bug-drawer.webp)

### Updated Report Headers

![New Headers](/bublik-release/blog/img/headers.webp)
