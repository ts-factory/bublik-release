...
![History reset filters](./img/history-reset-filters.webp)

### Measurements

We've also added a new page mode for history where you can see values change over time

![History charts](./img/history-charts.webp)
...
![History charts modal](./img/history-chart-modal.webp)
...
![Datepicker](./img/datepicker.webp)

### Date-range picker

![Date range picker](./img/date-range-picker.webp)
