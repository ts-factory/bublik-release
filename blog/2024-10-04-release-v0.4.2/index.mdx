...
We are happy to announce **Bublik v0.4.2**.
...
### Update Steps for Admins

To ensure a smooth transition and optimal use of the new features, please follow these steps to update your systems:

1. **Backup Configurations:**

   - Before updating, ensure all configuration settings are backed up in case rollback is necessary.

2. **Migrate global configuration file:**

3. **Verify Global Config:**

4. **Migrate Report Configurations:**
