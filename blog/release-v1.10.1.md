...
The new mode lets you view serial measurements for all iterations matching your search query.
You can select charts and switch to stacked mode to display them on the same axises for easier comparison.

![Series Charts](/bublik-release/blog/img/series-charts.webp)

### Improved Import

Added "RECIEVED" and "STARTED" import event types support

![Import](/bublik-release/blog/img/import.webp)

### Multiple Expected

Added support for multiple expected results

![Multiple Expected](/bublik-release/blog/img/results.webp)

### Limit axis y values

Added toggle button to limit axis y values for charts

![Limit axis y values](/bublik-release/blog/img/limit.webp)
